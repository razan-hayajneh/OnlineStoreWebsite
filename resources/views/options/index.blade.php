        ...
        <div class="card">
            <div class="card-body p-8">
                <button    class="group"style=" height:40px; border-radius: 8px;">
                    <a href="{{ route('options.create') }}" style="color:#fff" >
                ...
                <button type="button" class=" group" style="width: 80px;height:40px">
                    <a href="{{ route('options.exportPdf') }}" style="color:#fff" target="__blank">
                ...
                <button type="button" class=" group" style="width: 80px;height:40px">
                    <a href="{{ route('options.exportExcel') }}" style="color:#fff">
                        <div style="display: inline-block;">
