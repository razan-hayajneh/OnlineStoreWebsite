...
<head>
    <style>
        .group {
            /* box-shadow: 0px 4px 16px 0px rgb(#0069D9 / 15%); */
...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    <script>
        ...
        function getOptionKey() {
            ...
            var option_id = document.getElementById("optionId").value;
            var html = '';
            var city_id = '';
            $('#optionKeyId').empty();
            if (option_id) {
        ...
        // document.getElementsByClassName("custom-select").selectedIndex = -1;
    </script>
